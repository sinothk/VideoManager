...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.cover_player_controller_image_view_play_state) {
        ...
        } else if (view.getId() == R.id.cover_player_controller_image_view_switch_screen) {
    ...
    private void setBackIconVisibility(boolean showBackIcon) {
        if (showBackIcon) {
